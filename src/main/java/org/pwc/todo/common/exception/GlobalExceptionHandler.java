...
public class GlobalExceptionHandler {
	...
	public ErrorResponse handleEnumError(HttpMessageNotReadableException e) {
		if (e.getMessage().contains("Category")) {
			return new ErrorResponse(TodoErrorCode.INVALID_CATEGORY.getMessage(),
				TodoErrorCode.INVALID_CATEGORY.getCode());
		}
		throw e;
	}
}
